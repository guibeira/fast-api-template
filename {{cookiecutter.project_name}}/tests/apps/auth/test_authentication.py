...
from {{cookiecutter.project_slug}}.apps.auth.authentication import Token, authenticate_user, validate_token
from {{cookiecutter.project_slug}}.apps.users.schemas import pwd_context
...
@pytest.mark.asyncio
@patch("{{cookiecutter.project_slug}}.apps.auth.authentication.jwt.encode")
